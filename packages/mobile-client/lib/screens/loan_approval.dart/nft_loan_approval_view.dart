...
import 'package:unfold/screens/loan/nft_loan_view.dart'; // Make sure to add this package to your pubspec.yaml file

class NFTLoanApprovalView extends StatefulWidget {
  final EvaluationNft evaluation;

  const NFTLoanApprovalView({Key? key, required this.evaluation})
      : super(key: key);

  @override
  State<NFTLoanApprovalView> createState() => _LoanApprovalViewState();
}

class _LoanApprovalViewState extends State<NFTLoanApprovalView> {
